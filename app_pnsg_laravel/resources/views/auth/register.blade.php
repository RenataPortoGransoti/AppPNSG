<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="dataNascimento" class="block mt-1 w-full" type="dataNascimento" name="dataNascimento"
                :value="old('dataNascimento')" required autocomplete="dataNascimento" />
